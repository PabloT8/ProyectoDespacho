        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="views/nuevoad.php" class="nav-link">
                      <i class="fas fa-plus-square nav-icon"></i>
                      <p>Nuevo</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="views/consignasad.php" class="nav-link">
                      <i class="fas fa-calendar-check nav-icon"></i>
                      <p>Unidades</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="views/registro.php" class="nav-link">
         ...
         <li class="nav-item">
            <a href="views/detenidosad.php" class="nav-link">
                    ...
                    <div class="col-3 offset-4 shadow py-3">
                      <div class="upload-profile-image d-flex justify-content-center pb-5">
                        <div class="text-center">
                          <br>
                          <form name="form1" id="form1" method="POST" action="controllers/agregarconsignaad.php">
                            <label>Agente</label>
                            ...
                            <label>Fecha</label>
                            <input class="form-control" style="width:250px" type="date" name="consignafecha" id="consignafecha" required="true">
                            <br>
                            <label>Grupo</label>
                            <select class="form-control" style="width:250px" name="consignagrupo" id="consignagrupo" required="true" >
                              <option value=""></option>
                            ...
                            <br>
                            <label>Turno</label>
                            <select class="form-control" style="width:250px" name="consignaturno" id="consignaturno" required="true">
                              <option value=""></option>
