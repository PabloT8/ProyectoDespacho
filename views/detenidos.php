...
<div class="content-wrapper">
  ...
  <center>
  <form  name="form1" id="form1" method="POST" action="../controllers/agregardetenidos.php">
...
<label>Municipio</label>
  ...
  foreach ($resultado as $row) { ?>
    <tr>
      ...
      <td><?php echo "<a href='actualizardetenidos.php?detenidosid=".$row['detenidosid']."''><button type='button' class = 'btn btn-warning fas fa-edit'></button></a></td>"?>
      <td><?php echo "<a href='../controllers/eliminar.php?detenidosid=".$row['detenidosid']."''><button type='button' class = 'btn btn-danger fas fa-trash-alt'></button></a></td>"?> 
    </tr>
    <?php
  }  
  ?>
